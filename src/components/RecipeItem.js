    ...
    <div>
      {(loading && (
        <p className='container mx-auto py-8 text-center'>
          {error ? (
            <span className='text-2xl font-semibold  text-violet-300 lg:text-4xl text-center leading-normal'>
              {error}
            </span>
          ) : (
        ...
        <div className='recipe-item-section container mx-auto px-5 py-8 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:px-0'>
          ...
          <div className='recipe-details-sec flex flex-col gap-5 row-start-1 lg:row-auto'>
            ...
            <div className='buttons flex flex-col gap-5 items-start lg:flex-row'>
              ...
              <Link
                to='/'
                className='bg-gradient-to-br from-purple-400 to-purple-600 text-purple-50 p-3 px-8 rounded-lg text-sm uppercase font-bold tracking-wider mt-2 inline-block shadow-md shadow-rose-200 hover:shadow-lg hover:shadow-rose-300 duration-300 outline-none text-center'
              >
                Go Home
              </Link>
            </div>
          ...
          <div className='recipe-ingredients-sec col-span-full'>
            <span className='ing-title text-2xl lg:text-4xl font-medium mb-5 flex items-center gap-3'>
              <GiKnifeFork className='text-violet-500' />
              Ingredients:
            </span>
