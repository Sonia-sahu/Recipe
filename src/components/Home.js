  ...
  return (
    <div className='home container mx-auto py-8 flex flex-wrap gap-10 justify-center'>
      ...
      {!loading && !error && recipes.length === 0 ? (
        <div>
          <p className='text-2xl font-semibold  text-purple-300 lg:text-4xl text-center leading-normal'>
      ...
      {loading && (
        <p>
          {error ? (
            <span className='text-2xl font-semibold  text-purple-300 lg:text-4xl text-center leading-normal'>
              {error}
            </span>
          ) : (
